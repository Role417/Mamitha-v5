...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    elif query.data == "mallu":
        await query.answer("ഈ സിനിമ ഫയൽ/വീഡിയോ 10 മിനിറ്റിനുള്ളിൽ 🫥 നീക്കംചെയ്യപ്പെടും (പകർപ്പവകാശ പ്രശ്നങ്ങൾ കാരണം). നിങ്ങളുടെ സേവ് ചെയ്ത സന്ദേശങ്ങളിലേക്ക് ഈ ഫയൽ / വീഡിയോ ഫോർവേഡ് ചെയ്ത് അവിടെ ഡൗൺലോഡ് ചെയ്യാൻ ആരംഭിക്കുക", show_alert=True)

    elif query.data == "hindiu":
        await query.answer("यह मूवी फ़ाइल/वीडियो 10 मिनट 🫥 में हटा दिया जाएगा (कॉपीराइट मुद्दों के कारण)। कृपया इस फ़ाइल/वीडियो को अपने सहेजे गए संदेशों में अग्रेषित करें और वहां डाउनलोड करना प्रारंभ करें", show_alert=True)
    
    elif query.data == "tamilu":
        await query.answer("இந்த மூவி கோப்பு/வீடியோ 10 நிமிடங்களில் 🫥 நீக்கப்படும் (பதிப்புரிமைச் சிக்கல்கள் காரணமாக). தயவுசெய்து இந்த கோப்பு / வீடியோவை உங்கள் சேமித்த செய்திகளுக்கு திருப்பி அங்கு பதிவிறக்கத் தொடங்குங்கள்", show_alert=True)
